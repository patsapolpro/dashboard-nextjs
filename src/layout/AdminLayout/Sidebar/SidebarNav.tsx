...
export default function SidebarNav() {
  return (
    <ul className="list-unstyled">
      ...
      <SidebarNavItem icon={faRightToBracket} href="/upload">Issue credentials</SidebarNavItem>
      <SidebarNavItem icon={faCode} href="/request">Presentation request</SidebarNavItem>
